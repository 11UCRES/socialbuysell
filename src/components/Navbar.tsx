...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-card/90 backdrop-blur-2xl border-b border-border/40 shadow-[0_2px_8px_rgba(0,0,0,0.05)]">
      <div className="container mx-auto flex items-center justify-between h-[72px] px-6 lg:px-8">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-[10px] border border-border/80 text-xs font-semibold text-muted-foreground hover:text-foreground hover:border-primary/40 hover:bg-secondary/50 transition-all duration-200"
          >
          ...
          {user ? (
            ...
            <div className="flex items-center gap-3">
              <Link to="/login">
                <Button variant="ghost" size="sm" className="text-muted-foreground hover:text-foreground hover:bg-secondary/60 transition-all duration-200 font-medium px-4">{t("nav.login")}</Button>
              </Link>
              <Link to="/signup">
                <Button size="sm" className="gradient-primary text-primary-foreground border-0 rounded-[10px] px-5 py-2.5 h-auto font-semibold shadow-sm hover:shadow-md hover:brightness-95 transition-all duration-200">{t("nav.signup")}</Button>
              </Link>
            </div>
          )}
        </div>
        ...
        <div className="flex items-center gap-2 md:hidden">
          ...
          <button
            onClick={() => setLang(lang === "bn" ? "en" : "bn")}
            className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg border border-border/80 text-[11px] font-semibold text-muted-foreground hover:text-foreground transition-colors duration-200"
          >
